...
const PAGE_ORDER = ["home", "letter", "gallery", "wishes"];
...
function ConfettiRain({ count = 60 }) {
  const [pieces] = reactExports.useState(() => makeConfetti(count));
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: "pointer-events-none absolute inset-0 overflow-hidden",
      "aria-hidden": "true",
      children: pieces.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
...
function FloatingBalloons() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: "pointer-events-none absolute inset-0 overflow-hidden",
      "aria-hidden": "true",
      children: FLOATING_BALLOONS.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
...
function ConfettiBurst({ active }) {
  const [pieces] = reactExports.useState(() => makeBurst(80));
...
function RisingBalloons({ active }) {
  const [balloons, setBalloons] = reactExports.useState([]);
  reactExports.useEffect(() => {
    if (!active) return;
    setBalloons(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      className: "pointer-events-none absolute inset-0 overflow-hidden",
      "aria-hidden": "true",
      children: balloons.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
...
function FlowerCorner({ pos }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `absolute text-2xl ${cls}`, "aria-hidden": "true", children: "🌸" });
}
function PageDots({ current }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 justify-center", "aria-label": "Page progress", children: PAGE_ORDER.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      style: {
        ...
        boxShadow: current === p ? "0 0 8px #9B5DE5, 0 0 16px rgba(155,93,229,0.5)" : "none"
      }
    },
    p
  )) });
...
function App() {
  ...
  const [_animDir, setAnimDir] = reactExports.useState("in");
  const [visible, setVisible] = reactExports.useState(true);
  const goTo = reactExports.useCallback((next) => {
    setAnimDir("out");
    setVisible(false);
    setTimeout(() => {
      setPage(next);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background font-body", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          page === "home" && /* @__PURE__ */ jsxRuntimeExports.jsx(HomePage, { onNext: () => goTo("letter") }),
          page === "letter" && /* @__PURE__ */ jsxRuntimeExports.jsx(
            LetterPage,
            {
              onNext: () => goTo("gallery"),
              onBack: () => goTo("home")
          ...
          page === "gallery" && /* @__PURE__ */ jsxRuntimeExports.jsx(
            GalleryPage,
            {
              onNext: () => goTo("wishes"),
              onBack: () => goTo("letter")
          ...
          page === "wishes" && /* @__PURE__ */ jsxRuntimeExports.jsx(WishesPage, { wishesActive, onBack: () => goTo("home") })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "footer",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PageDots, { current: page }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "p",
            {
              ...
              children: [
                "Made with",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-pink-400", "aria-hidden": "true", children: "♥" }),
                " ",
                "using",
                " ",
...
function HomePage({ onNext }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      style: {
        background: "linear-gradient(160deg, #0D0015 0%, #1A0030 50%, #0A001F 100%)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(ConfettiRain, { count: 70 }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(FloatingBalloons, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center px-4 max-w-4xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex justify-center gap-3 text-5xl md:text-6xl animate-bounce", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h1",
            {
              ...
              style: {
                ...
                background: "linear-gradient(135deg, #E0B4FF 0%, #F72585 50%, #FFD700 100%)",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              style: { color: "#E0B4FF" },
              children: "To the most wonderful human I know"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "This little page was made with all my love, just for you 💌"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h2",
          {
            ...
            children: "A Letter From My Heart 💌"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            style: {
              ...
              boxShadow: "0 0 40px rgba(114,9,183,0.3), 0 0 80px rgba(247,37,133,0.1), inset 0 0 40px rgba(114,9,183,0.05)"
            },
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(FlowerCorner, { pos: "tl" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(FlowerCorner, { pos: "tr" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(FlowerCorner, { pos: "bl" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(FlowerCorner, { pos: "br" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "p",
                      {
                        ...
                        style: { color: "#E0B4FF" },
                        children: "My dearest bestie,"
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Where do I even begin? Every time I sit down to write this, my heart fills up so fast I can barely find the words. But today — your birthday — deserves every single one." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Do you remember the day we first met? I had absolutely no idea that moment would quietly become one of the most important chapters of my life. You walked in like you already owned the room, and somehow, you also walked straight into my heart." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The memories we've made together read like the most beautiful novel — full of laughter that made our stomachs hurt, late-night conversations that somehow solved everything, spontaneous adventures that we still talk about, and quiet moments that meant more than words could say. Through every season, you have been my constant." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "When life got heavy, you were the one who held the other end of the weight without even being asked. When I celebrated, you celebrated louder than anyone. You have this rare and magical gift of making people feel truly seen — and you have given that gift to me, over and over and over again." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: 'I think about all the inside jokes that only we understand, the songs that instantly take us somewhere, the places that are "ours." I think about how lucky I am to be the person who gets to call you their best friend. Not everyone gets a friendship like ours. I know that. And I am so, so grateful.' }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "On this birthday, I want you to know — truly know — how extraordinary you are. Not just to me, but to every single person whose life you touch. Your kindness is not a small thing. Your laughter is not a small thing. You are not a small thing. You are enormous, and bright, and the world is better with you in it." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "So here's my birthday wish for you: that this year brings you the kind of joy you so freely give to others. That every dream you've been quietly holding finally finds its way to you. That you wake up every morning feeling loved — because you are. Deeply, endlessly, always." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Thank you for existing. Thank you for being you. Thank you for being mine." }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "pt-4", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
                        {
                          className: "font-display text-xl italic block mb-1",
                          style: { color: "#E0B4FF" },
                          children: "Forever and always your bestie,"
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "span",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "A collection of us, through every season"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: GALLERY_IMAGES.map((img, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-[3/2] overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "img",
                    {
                      src: img.src,
                      alt: img.label,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "div",
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-sm font-semibold text-white", children: img.label })
                    }
                  )
                ]
              },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
...
function WishesPage({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      style: {
        background: "linear-gradient(135deg, #1A0030 0%, #0D0015 50%, #2D0040 100%)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(ConfettiBurst, { active: wishesActive }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(RisingBalloons, { active: wishesActive }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 max-w-3xl mx-auto text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center gap-2 text-5xl mb-6", children: WISHES_EMOJIS.map((e, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h2",
            {
              ...
              children: "Happy Birthday, Bestie!"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Wishing you endless joy, laughter, and all the cake in the world! 🎂"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10", children: WISH_CARDS.map((w, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              style: {
                ...
                boxShadow: "0 4px 24px rgba(114,9,183,0.15), inset 0 0 20px rgba(155,93,229,0.05)"
              },
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl mb-2", children: w.emoji }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                ...
                boxShadow: "0 0 40px rgba(114,9,183,0.2), inset 0 0 30px rgba(114,9,183,0.05)"
              },
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "span",
                      {
                        ...
                        style: { color: "#F72585" },
                        children: "Love you to the moon and back! 🌙✨"
                      }
                    )
                  ]
                }
